...
python ./parser/train.py --experiment-name ${1} --model ActionChannelModel --use-train-set --use-actions-api --use-synthetic-recipes --use-names-descriptions --log-level INFO
