...
python ./parser/train.py --experiment-name ${1} --model TriggerChannelModel --use-train-set --use-triggers-api --use-synthetic-recipes --use-names-descriptions --log-level INFO
